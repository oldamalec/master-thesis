...
const Sentry = {
    ...
    init() {
        if (Env.isProduction() || this.enableInDev) {
            // When this is enabled, there is **no console output** https://github.com/vuejs/vue/issues/8433
            SentryService.init({
                dsn: '<url>',
                integrations: [
